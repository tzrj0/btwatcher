...
const BT_API_URL = config.BT_API_URL;
const BT_API_KEY = config.BT_API_KEY;
...
function generateSignature() {
  ...
  const requestToken = md5(requestTime.toString() + md5(BT_API_KEY));
...
async function getRedirectList(siteName) {
  try {
    ...
    const response = await axiosInstance.post(
      `${BT_API_URL}site?action=GetRedirectList`,
      toUrlEncoded(params)
    );
...
async function modifyRedirect(redirectData) {
  try {
    ...
    const response = await axiosInstance.post(
      `${BT_API_URL}site?action=ModifyRedirect`,
      toUrlEncoded(params)
    );
...
async function getFileList(path) {
  try {
    ...
    const response = await axiosInstance.post(
      `${BT_API_URL}files?action=GetDir`,
      toUrlEncoded(params)
    );
...
async function getFileContent(path) {
  try {
    ...
    const response = await axiosInstance.post(
      `${BT_API_URL}files?action=GetFileBody`,
      toUrlEncoded(params)
    );
...
async function saveFileContent(path, content, encoding = 'utf-8') {
  try {
    ...
    const response = await axiosInstance.post(
      `${BT_API_URL}files?action=SaveFileBody`,
      toUrlEncoded(params)
    );
...
async function createFile(path) {
  try {
    ...
    const response = await axiosInstance.post(
      `${BT_API_URL}files?action=CreateFile`,
      toUrlEncoded(params)
    );
...
async function createFolder(path) {
  try {
    ...
    const response = await axiosInstance.post(
      `${BT_API_URL}files?action=CreateDir`,
      toUrlEncoded(params)
    );
...
async function deleteFile(path) {
  try {
    ...
    const response = await axiosInstance.post(
      `${BT_API_URL}files?action=DeleteFile`,
      toUrlEncoded(params)
    );
...
async function uploadFile(path, fileData) {
  try {
    ...
    const response = await axiosInstance.post(
      `${BT_API_URL}files?action=UploadFile`,
      form,
      {
        headers: {
          ...form.getHeaders()
...
async function addFirewallRule(ip, brief = '') {
  try {
    ...
    const response = await axiosInstance.post(
      `${BT_API_URL}v2/firewall/com/set_ip_rule`,
      toUrlEncoded(params)
    );
...
async function getFirewallRules(page = 1, pageSize = 100) {
  try {
    ...
    const response = await axiosInstance.post(
      `${BT_API_URL}v2/firewall/com/ip_rules_list`,
      toUrlEncoded(params)
    );
